...
exports.projects_add_new_project = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const userMentor = yield userSchema_1.default.findById(req.body.mentor).catch((err) => res.status(404).send('Mentor id is not valid'));
    if (!userMentor)
    ...
    const userAuthors = yield authorsArray.map((author) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const user = yield userSchema_1.default.findById(author).catch(() => res.status(404).send('Author id is not valid'));
        if (!user)
            res.status(404).send('Mentor not found');
        return user;
    }));
...
exports.projects_update_project = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const userMentor = userSchema_1.default.findById(req.body.mentor).catch((err) => res.status(404).send('Mentor id is not valid'));
    if (!userMentor)
        res.status(404).send('Mentor not found');
    const authorsArray = yield req.body.authors;
    const userAuthors = yield authorsArray.map((author) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
